...
//      Ct_L     Win_L    Alt_L                               SPACE                               Alt_R    FN       Ct_R     Left     Down     Right
    ...
    [1] = LAYOUT(
        ...
        _______, MY_RGB0, MY_RGB1, MY_RGB2, MY_RGB3, MY_RGB4, MY_RGB5, MY_RGB6, MY_RGB7, MY_RGB8, MY_RGB9, _______, _______, RESET,            RGB_SPI,
        ...
        _______, _______, _______,                            _______,                            MO(2),   _______, MY_ENMD, MY_ENSP, MY_ENBR, MY_ENSA
    ),
